...
|------              | --------------|-----------------|---------------------|-------------------|
| pcl radius search  |  228          |    249          | 454                |   218              |    
| gpu radius search  |  13.8         |    9.1          | 3.32               |   4.23             |  
| pcl approx nearest |  8.7          |    8.7          | 14.3               |   11.9             |  
| gpu approx nearest |  0.36         |    0.124        | 0.047              |   0.27             |  


|算法                         |  1165G7 (Win) 加速比 |  1165G7 (Linux) 加速比 | RTX2080 Ti 加速比 | A770(Linux) 加速比 |
|-----           |---------------------| ----------------------|------------------|------------------|
|radius          |16.52                |      27.4             |     136.7         |   51.5                    |
|approx nearest  |24.2                 |      70.2             |     304.3         |   44.1                   |
...
| 算法 (毫秒)        |  1165G7 (Win) |  1165G7 (Linux) | RTX2080 Ti  8700 (Linux) | A770 i7-12700 (Linux)  | 1165G7 (Win) 加速比 | RTX2080 Ti 加速比 |
|------              | --------------|-----------------|---------------------|-------------------|-------------------|-------------------|
| pcl radius search  |  228          |    249          | 454                |   218            |             |                   |
| gpu radius search  |  13.8         |    9.1          | 3.32               |   4.23        |   16.52     |     136.7         |
| pcl approx nearest |  8.7          |    8.7          | 14.3               |           |             |                   |
| gpu approx nearest |  0.36         |    0.124        | 0.047              |           |   24.17     |     304.3         |
...
cuda radius search took 2.765 milliseconds 
cuda radius search took 4.202 milliseconds 
cuda radius search took 4.318 milliseconds# gpucuda
